...
EL_NIDO_CONFIG = MovieConfig(
    ...
    queries=[
        "El nido Hugo Stuven",
        "El nido película",
        "El nido 2026 película",
        "El nido 2026 estreno",
        "El nido Michelle Jenner",
        "El nido thriller psicológico",
        "El nido crítica",
        "El nido reseña",
        "El nido tráiler",
        "El nido Filmax",
        "El nido terror español",
    ...
    queries_extra=[
        "El nido Hugo Stuven Filmax terror",
        "El nido familia thriller español 2026",
        "El nido Dylan Radley debut",
        "El nido Luisa Gavasa",
        "El nido Pablo Derqui",
        "El nido encierro familia película",
        "El nido personaje Velasco",
        "El nido crítica estreno septiembre",
        "El nido escenas sexo desnudo rating",
        "El nido final spoilers reseña",
    ],
    yt_queries=[
        "el nido película",
        "el nido hugo stuven tráiler",
        "el nido michelle jenner",
        "el nido estreno 2026",
        "el nido película terror español",
    ],
    contraste_queries=[
        "el nido",
        "el nido 2026",
    ...
    senales_negativas=[
        ...
        "bird", "birds", "nest", "birdhouse",
        "the nest", "sean durkin", "nido vacío", "nido vacio", "nido de amor",
