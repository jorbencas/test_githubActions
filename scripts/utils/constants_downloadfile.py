...
FUENTES = {
    ...
    "GitHub Topic Video Editing": {"url": "https://github.com/topics/video-editing?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Screen Recording": {"url": "https://github.com/topics/screen-recording?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Content Creation": {"url": "https://github.com/topics/content-creation?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Markdown": {"url": "https://github.com/topics/markdown?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Git": {"url": "https://github.com/topics/git?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Version Control": {"url": "https://github.com/topics/version-control?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Docker": {"url": "https://github.com/topics/docker?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Container": {"url": "https://github.com/topics/container?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Kubernetes": {"url": "https://github.com/topics/kubernetes?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Algorithms": {"url": "https://github.com/topics/algorithms?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Data Structures": {"url": "https://github.com/topics/data-structures?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Competitive Programming": {"url": "https://github.com/topics/competitive-programming?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Generative AI": {"url": "https://github.com/topics/generative-ai?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic AI Coding": {"url": "https://github.com/topics/ai-coding?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Open Source": {"url": "https://github.com/topics/open-source?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Awesome Lists": {"url": "https://github.com/topics/awesome-lists?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    # ── GitHub Topics (Image, Office, Presentations, Data Workflow) ──
    "GitHub Topic Image Processing": {"url": "https://github.com/topics/image-processing?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Image Editing": {"url": "https://github.com/topics/image-editing?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Computer Vision": {"url": "https://github.com/topics/computer-vision?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Document Processing": {"url": "https://github.com/topics/document-processing?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic PDF": {"url": "https://github.com/topics/pdf?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Office": {"url": "https://github.com/topics/office?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Presentation": {"url": "https://github.com/topics/presentation?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Slide Deck": {"url": "https://github.com/topics/slide-deck?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Data Pipeline": {"url": "https://github.com/topics/data-pipeline?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic ETL": {"url": "https://github.com/topics/etl?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Workflow Automation": {"url": "https://github.com/topics/workflow-automation?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Documentation Generator": {"url": "https://github.com/topics/documentation-generator?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic AI Code Review": {"url": "https://github.com/topics/ai-code-review?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    # ── GitHub Topics (Meetings, Documentation, AI Agents) ──
    "GitHub Topic Meeting Assistant": {"url": "https://github.com/topics/meeting-assistant?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Transcription": {"url": "https://github.com/topics/transcription?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Speech to Text": {"url": "https://github.com/topics/speech-to-text?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Wiki": {"url": "https://github.com/topics/wiki?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Knowledge Base": {"url": "https://github.com/topics/knowledge-base?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic AI Agent": {"url": "https://github.com/topics/ai-agent?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic LLM": {"url": "https://github.com/topics/llm?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic RAG": {"url": "https://github.com/topics/rag?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    # ── Repos específicos innovadores ──
    "OpenWiki": {"url": "https://github.com/langchain-ai/openwiki", "tipo": "herramienta", "subtipo": "github-repo"},
    "Meetily": {"url": "https://github.com/Zackriya-Solutions/meetily", "tipo": "herramienta", "subtipo": "github-repo"},
    "Code-to-Docs": {"url": "https://github.com/redhat-community-ai-tools/code-to-docs", "tipo": "herramienta", "subtipo": "github-repo"},
    "AutoPR": {"url": "https://github.com/irgolic/autopr", "tipo": "herramienta", "subtipo": "github-repo"},
    "PR-Agent": {"url": "https://github.com/qodo-ai/pr-agent", "tipo": "herramienta", "subtipo": "github-repo"},
    # ── GitHub Topics (Web Standards, Linux Config, Best Practices) ──
    "GitHub Topic CSS": {"url": "https://github.com/topics/css?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic HTML": {"url": "https://github.com/topics/html?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Web Standards": {"url": "https://github.com/topics/web-standards?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Frontend": {"url": "https://github.com/topics/frontend?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Linux Config": {"url": "https://github.com/topics/linux-config?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Dotfiles": {"url": "https://github.com/topics/dotfiles?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Linux Admin": {"url": "https://github.com/topics/linux-admin?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Best Practices": {"url": "https://github.com/topics/best-practices?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Coding Guidelines": {"url": "https://github.com/topics/coding-guidelines?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic Style Guide": {"url": "https://github.com/topics/style-guide?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic XML": {"url": "https://github.com/topics/xml?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    "GitHub Topic YAML": {"url": "https://github.com/topics/yaml?o=desc&s=stars", "tipo": "herramienta", "subtipo": "github-topic"},
    ...
    "AI Bytes": {"url": "https://aibytes.blog/", "selector": "article h2 a, h2 a", "quick": True, "tipo": "noticia"},
    "ToolChase": {"url": "https://toolchase.com/blog/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "ThePlanetTools": {"url": "https://theplanettools.ai/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "CompareThe.ai": {"url": "https://www.comparethe.ai/blog", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "YourAIChoice": {"url": "https://youraichoice.com/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "DeeperInsights": {"url": "https://deeperinsights.com/ai-review/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "AI Weekly": {"url": "https://aiweekly.co/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "NeelsWorld": {"url": "https://neelsworld.in/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "CleverAI": {"url": "https://cleverai.app/es/blog", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "IA News": {"url": "https://ia-news.es/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
    "DonWeb IA": {"url": "https://blog.donweb.com/ia-todos-lados-2026/", "selector": "article h2 a, h3 a", "quick": True, "tipo": "noticia"},
