...
AYUDA = (
    "🤖 *Soy el bot IA* (modelo local Qwen 2.5)\n\n"
    "*Cómo usarme:*\n"
    ...
    "*En un GRUPO:*\n"
    "1. Añádeme como miembro del grupo\n"
    "2. Con BotFather → `/setprivacy` → *Disable* (así leo todos los "
    "mensajes; si no, solo veré comandos y menciones)\n"
    "3. Úsame: `@bot tu pregunta`, `/ai ...` o `/help`\n\n"
    "*En un CANAL:*\n"
    "1. Añádeme como *administrador* (obligatorio: si no, Telegram no me "
    "entrega los mensajes del canal)\n"
    "2. Publica mencionándome: `@bot tu pregunta` — no puedo leer posts "
    "que no me mencionen ni responder en canales con comentarios "
    "desactivados\n"
    "3. Si el canal tiene grupo de comentarios vinculado, respóndeme ahí "
